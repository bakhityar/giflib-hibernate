...
public class CategoryController {
    ...
    public String addCategory(@Valid Category category, BindingResult result, RedirectAttributes redirectAttributes) {
        ...
        if (result.hasErrors()) {
            ...
            //Add category if invalid data received
            ...
            redirectAttributes.addFlashAttribute("flash", new FlashMessage("Categoru successfully added!", FlashMessage.Status.SUCCESS));
